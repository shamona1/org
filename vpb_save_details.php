...
{
	return isset($name) ? ucwords($name) : "";
}
		...
		if(isset($_POST['vpb_fullname']) && isset($_POST['vpb_username']) && isset($_POST['vpb_email']) && isset($_POST['vpb_passwd']) && !empty($_POST['vpb_fullname']) && !empty($_POST['vpb_username']) && !empty($_POST['vpb_email']) && !empty($_POST['vpb_passwd']))
		{
			...
			else
			{
				...
				while (!feof($vpb_database)) 
				{
					...
					$vpb_account_username = isset($vpb_fetch_detail[1]) ? trim(strip_tags(base64_decode($vpb_fetch_detail[1]))) : "";
					$vpb_account_email = isset($vpb_fetch_detail[2]) ? trim(strip_tags(base64_decode($vpb_fetch_detail[2]))) : "";
		...
		if(isset($_POST['vpb_username']) && isset($_POST['vpb_passwd']) && !empty($_POST['vpb_username']) && !empty($_POST['vpb_passwd']))
		{
			...
			else
			{
				...
				while (!feof($vpb_databases)) 
				{
					...
					$vpb_account_username = isset($vpb_fetch_details[1]) ? trim(base64_decode($vpb_fetch_details[1])) : "";
					$vpb_account_password = isset($vpb_fetch_details[3]) ? trim(base64_decode($vpb_fetch_details[3])) : "";
					...
					if (!empty($vpb_account_username) && !empty($vpb_account_password) && $vpb_account_username == $username) 
					{
						...
						if ($vpb_account_password == $encrypted_user_password)
						{
							...
							$_SESSION['validfullname'] = isset($vpb_fetch_details[0]) ? trim(strip_tags(base64_decode($vpb_fetch_details[0]))) : "";
							$_SESSION['validusername'] = isset($vpb_fetch_details[1]) ? trim(strip_tags(base64_decode($vpb_fetch_details[1]))) : "";
							$_SESSION['validemail'] = isset($vpb_fetch_details[2]) ? trim(strip_tags(base64_decode($vpb_fetch_details[2]))) : "";
							$_SESSION['validpassword'] = isset($vpb_fetch_details[3]) ? trim(strip_tags(base64_decode($vpb_fetch_details[3]))) : "";
						}
						else
						{
				...
				while (!feof($vpb_databases)) 
				{
					...
					if(!empty($vpb_account_username))
					{
						if($vpb_account_username == $username) 
						{
							...
							//Don't forget that the user information were encrypted before they were saved to a file hence the decoding below
							$_SESSION['vpb_fullname'] = isset($vpb_fetch_details[0]) ? trim(strip_tags(base64_decode($vpb_fetch_details[0]))) : "";
							$_SESSION['vpb_username'] = isset($vpb_fetch_details[1]) ? trim(strip_tags(base64_decode($vpb_fetch_details[1]))) : "";
							$_SESSION['vpb_email'] = isset($vpb_fetch_details[2]) ? trim(strip_tags(base64_decode($vpb_fetch_details[2]))) : "";
						}
					}
				}
		...
		if(isset($_POST['hidden_username']) && isset($_POST['new_password']) && !empty($_POST['hidden_username']) && !empty($_POST['new_password']))
		{
			...
			else
			{
				...
				while (!feof($vpb_databases)) 
				{
					...
					$vpb_account_username = isset($vpb_fetch_details[1]) ? trim(strip_tags(base64_decode($vpb_fetch_details[1]))) : "";
					
					// Validate Username
					if ($vpb_account_username == $username) 
					{
						$vpb_old_account_password = isset($vpb_fetch_details[3]) ? trim(strip_tags($vpb_fetch_details[3])) : "";
						...
						{
							$_SESSION['vpb_reset_fullname'] = isset($vpb_fetch_details[0]) ? trim(strip_tags(base64_decode($vpb_fetch_details[0]))) : "";
							$_SESSION['vpb_reset_username'] = isset($vpb_fetch_details[1]) ? trim(strip_tags(base64_decode($vpb_fetch_details[1]))) : "";
							$_SESSION['vpb_reset_email'] = isset($vpb_fetch_details[2]) ? trim(strip_tags(base64_decode($vpb_fetch_details[2]))) : "";
